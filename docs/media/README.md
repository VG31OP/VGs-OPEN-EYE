...
These bundled capture images (`youtube-popular-videos.png` and `open-source-survey.png`) originate from the upstream God's Eye View project and are retained here for historical asset provenance. The localized files preserve the source bytes unchanged.
